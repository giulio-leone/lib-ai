...
export declare class AIProviderConfigService {
     ...
     */
    static syncToVercel(provider: ProviderName, apiKey: string, environments?: VercelEnvironment[]): Promise<{
        success: boolean;
        envVarId?: string;
        error?: string;
    }>;
     ...
     */
    static toDTO(provider: AIProvider, data: {
        isEnabled: boolean;
        apiKey: string | null;
        updatedAt: Date | null;
        updatedBy?: string | null;
        metadata?: Record<string, unknown> | null;
    }, defaultModel?: string | null): ProviderConfigDTO;
    static enumToProviderName(provider: AIProvider): ProviderName;
    static buildMetadata(current: Prisma.JsonValue | null, params: {
        changeReason?: string;
        updatedBy?: string;
